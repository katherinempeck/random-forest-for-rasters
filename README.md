...
To test these functions, I created a dataset of fake site locations (that way I could share images of site distributions without concern about site sensitivity) on top of real environmental data. For the purposes of this example, the research question has to do with predicting small, "outlying" site locations relative to larger "urban center" sites. In theory, other users of this repository would have real data to which they could apply these functions. However, I still explain here in detail how I generated the fake data in case it might be useful for others. All initial data preparation was completed in QGIS (analogous functions exist for all these steps in ArcGIS Pro). Skip to **Read in Data** if your data is ready to go.
